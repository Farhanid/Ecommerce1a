...
const Cart = () => {
  ...
  return (
    <div className='container mx-auto py-8 min-h-96 px-4 md:px-16 lg:px-24'>
                ...
                <div className='md:w-2/3'>
                 ...
                 <div className='md:w-1/3 bg-white p-6 rounded-lg shadow-md border'>
                        ...
                        <div className='mb-4 border-b pb-2'>
                            ...
                            <button className='text-blue-500 hover:underlone mt-1 ml-2'
        ...
        <div className='text-center text-3xl font-extrabold text-blue-200 '>Your cart is empty</div>
        <p className='text-2xl font-medium text-center mt-4 mb-8'>Add something to make me happy</p>
        </div>}
